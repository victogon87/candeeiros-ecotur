        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="https://www.instagram.com/candeeiros_ecotur?igsh=MW02c3FqNzM2Y3A4cg==" target="_blank" rel="noopener noreferrer" className="social-icon">
                <Instagram size={20} />
              </a>
              <a href="#" className="social-icon">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
               ...
               <li>
                <a href="#canionsdourados" className="footer-link">Piquenique Cânion Dourado</a>
              </li>
              <li>
