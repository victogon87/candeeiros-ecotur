...
import canionsDouradosHero from '../assets/images/canions_dourados_hero.jpg';
...
const Hero = () => {
  ...
  const slides = [
    {
      image: canionsDouradosHero,
      title: "PIQUENIQUE CÂNION DOURADO",
      subtitle: "Do jeito que você sonhou ou como nunca imaginou. Venha viver e se apaixonar."
    },
    {
      image: canion2,
